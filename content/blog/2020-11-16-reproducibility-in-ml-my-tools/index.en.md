...
What we need is a database where to log our results and the settings of any experiments. But, I'm pretty sure you are not interested in creating your own database. Fortunately for us, different solutions exist to track results and experimentations. I will not go into details for all of them, but only focus on the two useful for my research projects. 
...
training_settings:
    ...
    device: "cuda:0"
```
Figure 3:  Example of a YAML file.
...
└── optimizer
    ...
    └── SGD.yaml
```
Figure 5:  Example of hierarchical configuration directory to rapidly manage your settings.
