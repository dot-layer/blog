...
Mes premières solutions ont été [Argparse](https://docs.python.org/3/howto/argparse.html) et [Configparser](https://docs.python.org/3/library/configparser.html). Ces solutions sont vraiment utiles, car elles sont faciles à mettre en place et leurs arguments sont lisibles. Par contre, plus vous ajoutez de paramètres, plus le code devient complexe, et il devient difficile de s'y retrouver. De plus, il est étrange de toujours se contenter de copier-coller du code pour créer de nouveaux arguments. Cela est contradictoire avec l'idée de la [Règle de trois](https://fr.wikipedia.org/wiki/R%C3%A8gle_de_trois_(programmation_informatique)) que "Si vous copiez-collez un bloc de code trois fois, vous risquez de créer une fonction." J'ai également essayé d'autres solutions telles que [Sacred](https://pypi.org/project/sacred/) avec des fichiers de configuration JSON, mais la librairie n'est pas bien conçues à mon avis. En somme, il manque quelque chose dans toutes ces solutions.
