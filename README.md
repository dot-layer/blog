...
4. Insert your post in the `content/blog/` directory. At this point, your post file should be a html or a markdown file. If you do not have any code to compile, you can simply create a new markdown file in that directory and start to write your post. Also, the name convention for your post should be : `YYYY-mm-dd-name-of-your-post`
